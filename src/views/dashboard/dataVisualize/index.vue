        ...
        <el-row :gutter="40">
          ...
          <el-col class="mb40" :xs="24" :sm="12" :md="12" :lg="8" :xl="8">
            <div class="item-center">
              <div class="gitee-traffic traffic-box">
                <div class="traffic-img img-border">
                  <img src="./images/add_person.jpg" alt="" />
                </div>
                <span class="item-value">161,552</span>
                <span class="traffic-name sle txt-tick" @click="goOpen('https://blog.csdn.net/qq2754289818')">CSDN 访问量</span>
              </div>
              <div class="gitHub-traffic traffic-box">
                <div class="traffic-img">
                  <img src="./images/GitHub.png" alt="" />
                </div>
                <span class="item-value">8866</span>
                <span class="traffic-name sle txt-tick" @click="goOpen('https://github.com/Medalc')">GitHub 访问量</span>
              </div>
          ...
          <el-col class="mb40" :xs="24" :sm="24" :md="24" :lg="10" :xl="10">
            <div class="item-right">
              <div class="echarts-title">CSDN / GitHub 访问量占比</div>
